    ...
    for line in fin:
      ...
      if re.match('^ *[Uu][Ss][Ee]',line):
        ...
        try:
          ...
          print('Issue with '+file_name+' on line '+line+'. Likely a match for USE that is not a use statement.') 
################################################################################
      ...
      #     (case insensitive)
        ...
        try:
          ...
          print('Issue with '+file_name+' on line '+line+'. Likely a match for INCLUDE that is not an include statement.') 
################################################################################
