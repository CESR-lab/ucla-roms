...
#  endif
     ...
     &                              -DC(i,k+1)*FC(i,k-1))
        ...
        do i=1,nx
#  if defined NEUMANN_UV
          FC(i,nz)=(3.*u(i,j,nz,nrhs)-FC(i,nz-1))/(2.-CF(i,nz))
#  else
...
# else
     ...
     &                        -0.0625*(We(i+1,j,k)+We(i-2,j,k)))
        ...
        do i=1,nx
          FC(i,nz)=0.
          FC(i,nz-1)=( 0.5625*(u(i,j,nz-1,nrhs)+u(i,j,nz,nrhs))
     &                 -0.0625*(u(i,j,nz-2,nrhs)+u(i,j,nz,nrhs)))
     &                 *( 0.5625*(We(i  ,j,nz-1)+We(i-1,j,nz-1))
     &                   -0.0625*(We(i+1,j,nz-1)+We(i-2,j,nz-1)))
...
#  endif
     ...
     &                                -DC(i,k+1)*FC(i,k-1))
          ...
          do i=1,nx
#  if defined NEUMANN_UV
            FC(i,nz)=(3.*v(i,j,nz,nrhs)-FC(i,nz-1))/(2.-CF(i,nz))
#  else
...
# else
     ...
     &                         -0.0625*(We(i,j+1,k)+We(i,j-2,k)))
          ...
          do i=1,nx
            FC(i,nz)=0.
            FC(i,nz-1)=(  0.5625*(v(i,j,nz-1,nrhs)+v(i,j,nz,nrhs))
     &                  -0.0625*(v(i,j,nz-2,nrhs)+v(i,j,nz,nrhs)))
     &                  *( 0.5625*(We(i,j  ,nz-1)+We(i,j-1,nz-1))
     &                    -0.0625*(We(i,j+1,nz-1)+We(i,j-2,nz-1)))
